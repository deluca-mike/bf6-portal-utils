...
export namespace MultiClickDetector {
    ...
    // Subscribed to OnTickStart at priority Normal (0) to sample soldier input states as early as possible
    // in the frame, ensuring responsive click detection before other event handlers run.
