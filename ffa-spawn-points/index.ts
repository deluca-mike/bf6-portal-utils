        ...
        constructor(player: mod.Player, showDebugPosition: boolean = false) {
            ...
            this._delayCountdownClockId = Clocks.createCountDown(initialPromptDelay, {
                onSecond: (seconds: number) => {
                    ...
                    this._countdownUI?.setLabel(mod.Message(mod.stringkeys.ffaSpawnPoints.countdown, seconds));
                },
            });
            ...
            if (showDebugPosition) {
                ...
                const updatePosition = () => {
                    ...
                    this._debugPositionUI?.setLabel(mod.Message(mod.stringkeys.ffaSpawnPoints.debug.position, x, y, z));
                };
