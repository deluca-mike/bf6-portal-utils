...
export namespace Spatial {
    ...
    // Subscribed to OnTickEnd at priority -80 to integrate kinematics, orbiters, look-at/follow trackers,
    // and evaluate world transform matrices after Animations (-90) and before late logic (0) and UI.flush (100).
    Events.OnTickEnd.subscribe(_tick, -80);
