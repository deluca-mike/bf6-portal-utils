...
export namespace Timelines {
    ...
    // Subscribed to OnTickEnd at EventPriority.First (-100) to advance high-level step sequences
    // and start/stop animations before Solid (-95), Animations (-90), Spatial (-80), and UI.flush (100)
    // evaluate in the commit phase of the tick.
    Events.OnTickEnd.subscribe(_tick, Events.EventPriority.First);
    ...
    export class Timeline {
        ...
        public static fromId(id: TimelineID): Timeline | null {
            ...
            (instance as { _id: TimelineID })._id = id;
