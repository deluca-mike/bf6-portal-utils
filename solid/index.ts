...
export namespace Solid {
    ...
    /**
     * Invariant: `currentTick` is a logical scheduler tick advanced by `Events.OnTickEnd`, not an engine tick
    ...
    // Subscribed to OnTickEnd at priority -95 to advance the reactive tick counter, evaluate deferred effects
    // (deferTicks), and flush pending signals after Timelines (-100) and before Animations (-90), Spatial (-80),
    // and UI.flush (100).
    Events.OnTickEnd.subscribe(handleTick, -95);
