...
export declare namespace UI {
    ...
    export const ZERO_VECTOR: mod.Vector;
    /**
    ...
    export abstract class Element extends Node {
        protected static readonly _ROOT_NODE_ID = 0;
        protected static readonly _INVALID_INDEX = -1;
        protected static readonly _elementToCustomSlot: Int16Array;
        protected static readonly _DIRTY_POSITION: number;
        protected static readonly _DIRTY_SIZE: number;
        protected static readonly _DIRTY_BG_COLOR: number;
        protected static readonly _DIRTY_BG_ALPHA: number;
        protected static readonly _DIRTY_BG_FILL: number;
        protected static readonly _DIRTY_DEPTH: number;
        protected static readonly _DIRTY_ANCHOR: number;
        protected static readonly _DIRTY_VISIBLE: number;
        protected static readonly _DIRTY_PARENT: number;
        protected static readonly _DIRTY_PADDING: number;
        protected static readonly _DIRTY_FOREGROUND_COLOR: number;
        protected static readonly _DIRTY_FOREGROUND_ALPHA: number;
        /**
