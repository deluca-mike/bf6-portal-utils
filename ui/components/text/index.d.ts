...
export declare class UIText extends UI.Element {
    protected static readonly _DIRTY_TEXT_LABEL: number;
    protected static readonly _DIRTY_TEXT_ANCHOR: number;
    protected static readonly _DIRTY_TEXT_SIZE: number;
    protected static readonly _UNUSED_DIRTY_OFFSET: number;
    private static readonly _labels;
    private static readonly _textAnchor;
    private static readonly _textSize;
    /**
     * Creates a new text.
